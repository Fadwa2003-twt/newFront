...
function CreateContentCategoryModal(props) {
    ...
    const handleSubmit = (valuesCategory) => {
        const values = {...valuesCategory, textFiles:acceptedFiles};
    ...
    return (
        <DefaultModal
            ...
            isTitle={true}
            title={"انشاء تصنيف محتوى"}
        >
            <Formik initialValues={{ name: "", supervisor: "" }} onSubmit={handleSubmit}>
                        ...
                        >
                            ...
                            <div className="w-full mt-3">
                                <div className={"flex gap-2 items-baseline"}>
                                    ...
                                    <text className={"text-lg"}>مجلد الملفات</text>
                                </div>
...
export default CreateContentCategoryModal;