...
import DeleteStoriesLinks from "../../Story/components/DeleteStoriesLinks";
import DeleteReelsAction from "../../../../../redux/action/insta/DeleteReels.action";
import DeleteReelsLinks from "./DeleteReelsLinks";

function DeleteReels(props) {
    console.log(props);
    ...
    const deleteStoriesByCount = () => {
        if (count <= 0) {
            ...
            if (accountsName.length === 0) {
                aleartsToast("error", "يرجى اختيار الحسابات التي تود حذف الريل الخاص بها");
            } else {
    ...
    return (
        <>
                    ...
                    <div className="bg-white p-4">
                        <div className="grid gap-4 items-center">
                            ...
                            <div className="flex">
                                ...
                                />
                                <label> الريل التي تود حذفها</label>
                            </div>
                        </div>
            ...
            <DeleteReelsLinks selectedAccounts={props.selectedAccounts} isModalOpen={isOpenDeleteStoriesLinks} onClose={() =>
                setIsOpenDeleteStoriesLinks(!isOpenDeleteStoriesLinks)}/>
        </>
    );
}
