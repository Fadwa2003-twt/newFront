...
function DeleteTweetsLinks(props) {
    ...
    return (
        <DefaultModal title={"التويتات التي تود حذفها"} classNameModal={"w-full md:w-[40%] border-primary rounded-[11px] shadow-lg"} isModalOpen={props.isModalOpen} onClose={props.onClose}
        ...
        >
            ...
            <div className={"modal-body p-4"}>
                <DataTableRows spinner={isLoading} selectedAccounts={props.selectedAccounts} type={"deleteTweets"} a thirdBtnTitle={"حذف"} />
            </div>
...
export default DeleteTweetsLinks;